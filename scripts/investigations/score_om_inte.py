"""Score `om inte` patterns against the frozen gold set.
    ...
    python scripts/investigations/score_om_inte.py
    python scripts/investigations/score_om_inte.py --show-changes current allowlist
...
from simulacria.pipeline.silver import POOLS, PROJECT_ROOT, load_provisions
