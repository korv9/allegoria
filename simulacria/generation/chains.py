...
from simulacria.generation.design import create, ended_chains, save_manifest  # noqa: F401
from simulacria.generation.plan import digest
...
def execute(
    ...
    # The key follows the run's own transformer: a resumed run may have been
    # created against a different provider than the current default.
    key = api_key(root, manifest["transformer_model"])
