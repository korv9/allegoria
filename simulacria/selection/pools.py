"""SELECTION. Corpus pools, the Silver build, and its count contract.

Not measurement, but not a heuristic either -- this is the data layer the
heuristics run over. It lives under `selection` because that is who consumes it;
nothing here interprets a provision.
